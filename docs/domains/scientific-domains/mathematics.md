...
# ➗ Mathematics  
A curated collection of mathematics resources for research, numerical modeling, algorithms, and theoretical foundations.
...
- **Khan Academy — Mathematics**  
  ...
  Free courses for foundational and advanced mathematics.
...
- **TheAlgorithms (Math)**  
  https://github.com/TheAlgorithms/Math  
...
- **3Blue1Brown (Mathematics Visualization)**  
